...
#sample output
# enter no of items : 5
# enter the 1 th number : 3
# enter the 2 th number : 2
# enter the 3 th number : 7
# enter the 4 th number : 4
# enter the 5 th number : 1
# Enter number for pair : 8
# {(7,1)}
